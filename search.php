...
?>
		...
		?>
				  ...
				  <div class='row' >
					...
					$search=substr($search,0,50); //limiting the string length to 50 characters
					...
					$SQL = "SELECT * FROM products WHERE (productid $combined AND productname LIKE '%".$search."%') AND status !='removed' ORDER BY productid DESC ";
